...
const SAMPLE_DATA = {
  ...
  dailyLogs: [
    { 날짜: '2026-04-02', 주차: '2026-04-08', 대리점코드: 'AG001', 대리점명: '(주)하나여행사', 보고구분: '공식인증',  업무구분: '견적', 상품코드: 'ATQ053260615OZ1', 견적인입여부: 1, 체결여부: 0, 인원: 25, 매출: 0,          내용: '유럽 패키지 견적 협의',  다음액션: '가격 재협의', 상태: '진행중' },
    { 날짜: '2026-04-03', 주차: '2026-04-08', 대리점코드: 'AG002', 대리점명: '태양관광(주)',   보고구분: '일반대리점', 업무구분: '예약', 상품코드: 'ATQ053260720KE1', 견적인입여부: 1, 체결여부: 1, 인원: 40, 매출: 88000000, 내용: '일본 단체 예약 확정',  다음액션: '계약금 수령', 상태: '완료' },
    { 날짜: '2026-04-04', 주차: '2026-04-08', 대리점코드: 'AG003', 대리점명: '미래투어',       보고구분: '공식인증',  업무구분: '견적', 상품코드: 'ATQ053260810UA1', 견적인입여부: 1, 체결여부: 0, 인원: 30, 매출: 0,          내용: '미국 기업 단체 견적 발송', 다음액션: '대안 상품 준비', 상태: '진행중' },
    { 날짜: '2026-04-05', 주차: '2026-04-08', 대리점코드: 'AG004', 대리점명: '드림여행사',     보고구분: '일반대리점', 업무구분: '기타', 상품코드: '',                  견적인입여부: 0, 체결여부: 0, 인원: 0,  매출: 0,          내용: '신규 대리점 첫 미팅',   다음액션: '견적 준비',    상태: '완료' },
    { 날짜: '2026-04-06', 주차: '2026-04-08', 대리점코드: 'AG001', 대리점명: '(주)하나여행사', 보고구분: '공식인증',  업무구분: '견적', 상품코드: 'ATQ053260905OZ2', 견적인입여부: 1, 체결여부: 0, 인원: 50, 매출: 0,          내용: '9월 유럽 대형 견적 협의', 다음액션: '추가 옵션 협의', 상태: '진행중' },
  ],
  incentives: [
    {
